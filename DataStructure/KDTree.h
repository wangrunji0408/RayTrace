...
private:
    ...
    void getIntersectSpaces (Ray const& ray, AxisBox const& bound, std::vector<int> &result, Iterc begin, Iterc end, int d) const;
public:
    KDTree () {}
    ...
    std::vector<int> getIntersectSpaces (Ray const& ray, AxisBox const& globalBound) const;
